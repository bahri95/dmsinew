<?php /* Smarty version Smarty-3.1.17, created on 2016-08-19 00:55:34
         compiled from "application/views/private/banner/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:195715709257a86b1e96a144-08480925%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '195715709257a86b1e96a144-08480925',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_57a86b1eab7f54_72797660',
  'variables' => 
  array (
    'url_private' => 0,
    'url_list' => 0,
...
<?php if ($_valid && !is_callable('content_57a86b1eab7f54_72797660')) {function content_57a86b1eab7f54_72797660($_smarty_tpl) {?><section class="content-header">
                    <h1>
                     Banner
                        <small>panel</small>
                    </h1>
...
"><i class="fa "></i>Data Banner</a></li>
                        <li class="active">Update Data Banner</li>
                    </ol>
                </section>
...
" size="100" maxlength="255" />
                                         ...
                                         <div class="form-group">
                                          ...
                                          <select id="show" class="form-control" name="masa_aktif" onchange="change()" style="width:200px;">
                                              <option value="sementara" <?php if ($_smarty_tpl->tpl_vars['data']->value['masa_aktif']=='sementara') {?>selected="selected"<?php }?>>Sementara</option>
                                              <option value="tetap" <?php if ($_smarty_tpl->tpl_vars['data']->value['masa_aktif']=='tetap') {?>selected="selected"<?php }?>>Tetap</option>
...
" class="tanggal form-control" size="10" maxlength="10" style="width:150px;" />
                                        ...
                                        <div class="form-group">
                                          ...
                                          <select  class="form-control" name="status" style="width:200px;">
                                              <option value="active" <?php if ($_smarty_tpl->tpl_vars['data']->value['status']=='active') {?>selected="selected"<?php }?>>Aktif</option>
                                              <option value="nonactive" <?php if ($_smarty_tpl->tpl_vars['data']->value['status']=='nonactive') {?>selected="selected"<?php }?>>Tidak Aktif</option>
