<?php /* Smarty version Smarty-3.1.17, created on 2016-07-13 09:33:54
         compiled from "application/views/private/agenda/add.html" */ ?>
<?php /*%%SmartyHeaderCode:534091695785a89253db67-38969864%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '534091695785a89253db67-38969864',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5785a892619b73_37356253',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5785a892619b73_37356253')) {function content_5785a892619b73_37356253($_smarty_tpl) {?>                <section class="content-header">
                    <h1>
                      Jadwal Kegiatan
                        <small>panel</small>
                    </h1>
                                 ...
                                 <div class="tab-pane active" id="tab_1">
                                   <div class="box-body">
                                         <div class="form-group">
                                            <label for="user_name_lama">DMSI & Asosiasi *   </label>
...
" class="form-control" size="50" maxlength="255" />
                                        ...
                                        <div class="form-group">
                                           ...
                                           <textarea name="keterangan" cols="72" rows="10" class="textarea"  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $_smarty_tpl->tpl_vars['data']->value['content'];?>
</textarea>
                                        </div>
                                         <div class="form-group">
                                   ...
                                   <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="user_name_lama">Event Title * </label>
                                            <input type="text" name="judul_english" id="judul_agenda" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['judul_agenda'];?>
" class="form-control" size="50" maxlength="255" />
                                        </div>
                                      
                                        <div class="form-group">
                                            <label for="user_name_lama">Information</label>
                                           <textarea name="keterangan_english" cols="72" rows="10" class="textarea"  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $_smarty_tpl->tpl_vars['data']->value['content'];?>
</textarea>
                                        </div>
