<?php /* Smarty version Smarty-3.1.17, created on 2016-08-09 06:31:46
         compiled from "application\views\private\harga\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:1619757a95c8cb31d28-95150454%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '042ce8171f3aa2c27562cc5de73294e605f7add1' => 
    array (
  ...
  'nocache_hash' => '1619757a95c8cb31d28-95150454',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_57a95c8cbd9cc2_24720061',
  'variables' => 
  array (
    'url_private' => 0,
    'url_list' => 0,
...
<?php if ($_valid && !is_callable('content_57a95c8cbd9cc2_24720061')) {function content_57a95c8cbd9cc2_24720061($_smarty_tpl) {?>                <section class="content-header">
                    <h1>
                      Harga
                        <small>panel</small>
                    </h1>
                        ...
                        <!-- form update email-->
                             <div class="box box-success">
                                <div class="box-header">
                                    <h3 class="box-title">Edit Data Harga</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
...
">
                                            <label for="user_name_lama">Kategori Harga *</label>
                                            <select name="id_katharga" class="form-control" style="width:200px;" > 
...
" id="tahun" class="form-control" size="10" maxlength="10" style="width:150px;" />
                                        ...
                                        <div class="form-group">
                                            <label for="user_name_lama">Bulan *</label>
...
" <?php if ($_smarty_tpl->tpl_vars['data']->value['id_bulan']==$_smarty_tpl->tpl_vars['result']->value['id_bulan']) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['result']->value['lengkap'];?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="user_name_lama">Harga (Rupiah) *</label>
...
" class="form-control" size="10" maxlength="10" style="width:250px;" />
                                        ...
                                        <div class="form-group">
                                            <label for="user_name_lama">Harga (Dolar) *</label>
