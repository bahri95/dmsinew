...
<?php /*%%SmartyHeaderCode:2067318458577232ff4e86b0-80746829%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2067318458577232ff4e86b0-80746829',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_577232ff5b0153_25047705',
  'variables' => 
  array (
    'url_private' => 0,
    'total_foto' => 0,
...
<?php if ($_valid && !is_callable('content_577232ff5b0153_25047705')) {function content_577232ff5b0153_25047705($_smarty_tpl) {?>                <section class="content-header">
                    <h1>
                        Dashboard
                        <small>panel</small>
                    </h1>
                                ...
                                <div class="inner">
                                    <h5>
                                       <table>
                                        ...
                                        <tr>
                                        <td>Foto &nbsp; </td><td><?php echo $_smarty_tpl->tpl_vars['total_foto']->value;?>
 dari <?php echo $_smarty_tpl->tpl_vars['total_album']->value;?>
 Album</td>
                                        <tr/>
                                       
                                         <tr>
                                        <td>Video &nbsp; </td>  <td><?php echo $_smarty_tpl->tpl_vars['total_video']->value;?>
</td>
                                        </tr>
                                        </table>
                                    </h5>
...
" class="small-box-footer">
                                    Foto <i class="fa fa-arrow-circle-right"></i>
                                </a>
                                 <a href="<?php echo $_smarty_tpl->tpl_vars['url_video']->value;?>
" class="small-box-footer">
                                    Video <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            ...
                            <div class="small-box bg-green">
                                <div class="inner">
                                    <h5>
                                       <table>
                                        <tr>
                                        <td>Informasi &nbsp; </td><td><?php echo $_smarty_tpl->tpl_vars['total_informasi']->value;?>
</td>
                                        <tr/>
                                        <tr>
                                        <td>Opini &nbsp; </td>  <td><?php echo $_smarty_tpl->tpl_vars['total_opini']->value;?>
</td>
                                        </tr>
                                         <tr>
                                        <td>Serba-serbi &nbsp; </td>  <td><?php echo $_smarty_tpl->tpl_vars['total_sesebi']->value;?>
</td>
                                        </tr>
                                        </table>
                                    </h5>
...
" class="small-box-footer">
                                    Informasi <i class="fa fa-arrow-circle-right"></i>
                                </a>
                                 <a href="<?php echo $_smarty_tpl->tpl_vars['url_opini']->value;?>
" class="small-box-footer">
                                    Opini <i class="fa fa-arrow-circle-right"></i>
                                </a>
                                 <a href="<?php echo $_smarty_tpl->tpl_vars['url_sesebi']->value;?>
" class="small-box-footer">
                                    Serba-serbi <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                <div class="inner">
                                    <h4>
                                        <table>
                                        <tr>
                                        <td>Berita &nbsp; </td><td><?php echo $_smarty_tpl->tpl_vars['berita']->value;?>
</td>
                                        <tr/>
                                        <tr>
                                        <td>Event &nbsp; </td>  <td><?php echo $_smarty_tpl->tpl_vars['event']->value;?>
</td>
                                        </tr>
                                        </table>
                                    </h4>
...
" class="small-box-footer">
                                    Berita <i class="fa fa-arrow-circle-right"></i>
                                </a>
                                 <a href="<?php echo $_smarty_tpl->tpl_vars['url_event']->value;?>
" class="small-box-footer">
                                    Event <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                <div class="inner">
                                   <h5>
                                        <table>
                                        <tr>
                                        <td>Baru &nbsp; </td><td><?php echo $_smarty_tpl->tpl_vars['total_aspirasi_baru']->value;?>
</td>
                                        <tr/>
                                        <tr>
                                        <td>Diverifikasi &nbsp; </td>  <td><?php echo $_smarty_tpl->tpl_vars['total_aspirasi_ver']->value;?>
</td>
                                        </tr>
                                         <tr>
                                        <td>Dijawab &nbsp; </td>  <td><?php echo $_smarty_tpl->tpl_vars['total_aspirasi_jaw']->value;?>
</td>
                                        </tr>
                                        </table>
                                    </h5>
...
" class="small-box-footer">
                                    Baru <i class="fa fa-arrow-circle-right"></i>
                                </a>
                                <a href="<?php echo $_smarty_tpl->tpl_vars['url_aspirasi_ver']->value;?>
" class="small-box-footer">
                                    Diverifikasi <i class="fa fa-arrow-circle-right"></i>
                                </a>
                                 <a href="<?php echo $_smarty_tpl->tpl_vars['url_aspirasi_jaw']->value;?>
" class="small-box-footer">
                                    Dijawab <i class="fa fa-arrow-circle-right"></i>
                                </a>
