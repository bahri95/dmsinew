<?php /* Smarty version Smarty-3.1.17, created on 2016-08-04 05:29:12
         compiled from "application/views/private/foto/add_foto.html" */ ?>
<?php /*%%SmartyHeaderCode:137427672957736377a91261-99620513%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '137427672957736377a91261-99620513',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_57736377b57109_61371425',
  'variables' => 
  array (
    'album' => 0,
    'url_private' => 0,
...
<?php if ($_valid && !is_callable('content_57736377b57109_61371425')) {function content_57736377b57109_61371425($_smarty_tpl) {?><section class="content-header">
                    <h1>
                                ...
                                <div class="box-header">
                                  <h3 class="box-title">Tambah Foto</h3>
                                    <div class="box-body">
                                        ...
                                        <div class="btn-group pull-right"><a href="<?php echo $_smarty_tpl->tpl_vars['url_list_foto']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['album']->value['id_album'];?>
" title="List Foto" class="btn bg-olive btn-flat"><i class='fa fa-list'></i> List Foto</a>
                                        </div>
...
">
                                              ...
                                              <label>Pilih File Foto * </label>
                                                ...
                                                <center><img id="output" style="height:200px; margin-top:20px;"></center>
                                             <div class="form-group">
                                                  <label for="user_name_la">Judul *</label>
                                                   <input type="text" name="judul_foto" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['nama_album'];?>
" size="100"  maxlength="255" />
                                             </div>
                                             <div class="form-group">
                                                  <label for="user_name_la">Judul (<i>English</i>) *</label>
