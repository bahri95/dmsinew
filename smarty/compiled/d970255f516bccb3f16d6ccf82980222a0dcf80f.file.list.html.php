<?php /* Smarty version Smarty-3.1.17, created on 2016-08-19 00:55:30
         compiled from "application/views/private/banner/list.html" */ ?>
<?php /*%%SmartyHeaderCode:167946513757a869c7c82bc7-35809715%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '167946513757a869c7c82bc7-35809715',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_57a869c7f38334_67863462',
  'variables' => 
  array (
    'url_private' => 0,
    'notification_msg' => 0,
...
<?php if ($_valid && !is_callable('content_57a869c7f38334_67863462')) {function content_57a869c7f38334_67863462($_smarty_tpl) {?>
...
" title="Tambah Data" class="btn bg-olive btn-flat"><i class='fa fa-plus'></i> Tambah Album</a>
                                        </div>
                                        ...
                                        <table id="table_datagrid" class="table table-bordered table-striped">
                                            <thead>
                                               ...
                                               <th width="5%" id="cekAll"><input type="checkbox" class="checked-all" name="checked-all"  id="checked-all"/ class="form-control"></th>
                                                ...
                                                <th width="10%">Banner Indonesia</th>
                                                <th width="10%">Banner English</th>
                                                <th width="15%">Nama Banner</th>
                                                <th width="10%">Masa Aktif</th>
...
?>
                                            <tr>
                                               <td align="center"><input type=checkbox name="id_banner[]" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['id_banner'];?>
" class="checkbox" /></td>
