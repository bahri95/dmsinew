<?php /* Smarty version Smarty-3.1.17, created on 2016-08-19 00:54:33
         compiled from "application/views/private/sosmed/list.html" */ ?>
<?php /*%%SmartyHeaderCode:93444591457b69109f2faf4-74839396%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '93444591457b69109f2faf4-74839396',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57b6910a0f2752_63723545',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b6910a0f2752_63723545')) {function content_57b6910a0f2752_63723545($_smarty_tpl) {?>
...
" title="Tambah Data" class="btn bg-olive btn-flat"><i class='fa fa-plus'></i> Tambah Sosial Media</a>
                                        </div>
                                        ...
                                        <table id="table_datagrid" class="table table-bordered table-striped">
                                            <thead>
                                               ...
                                               <th width="5%" id="cekAll"><input type="checkbox" class="checked-all" name="checked-all"  id="checked-all"/ class="form-control"></th>
                                                ...
                                                <th width="10%">Nama Sosmed</th>
                                                <th width="10%">Nama Logo</th>
                                                <th width="20%">Link</th>
                                                <th width="7%"></th>
                                                </tr>
                                            </thead>
...
?>
                                            <tr>
                                               <td align="center"><input type=checkbox name="id_sosmed[]" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['id_sosmed'];?>
" class="checkbox" /></td>
