<?php /* Smarty version Smarty-3.1.17, created on 2016-07-19 08:53:00
         compiled from "application\views\private\account\akun.html" */ ?>
<?php /*%%SmartyHeaderCode:7273578dce4c4fa9a4-61900553%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '7273578dce4c4fa9a4-61900553',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_578dce4c6bbd95_56559170',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_578dce4c6bbd95_56559170')) {function content_578dce4c6bbd95_56559170($_smarty_tpl) {?>                <section class="content-header">
                    <h1>
                        Akun Login
                        <small>panel</small>
                    </h1>
...
" />
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="user_name_lama">Username Lama </label>
...
" class="form-control" maxlength="30" size="30"  disabled="disabled"/>
                                        ...
                                        <div class="form-group">
                                            <label for="user_name_baru">Username Baru</label>
...
" class="form-control" maxlength="30" size="30" />
                                    ...
                                    <div class="box-footer">
                                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Simpan Username</button>
                                    </div>
                                </form>
                            </div><!-- /.box -->
...
" method="post">
                                   <div class="box-body">
                                        <div class="form-group">
                                            <label for="user_name_lama">Email Lama</label>
                                            <input type="text" name="user_mail_lama" id="user_mail_lama" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['user_mail'];?>
"  class="form-control"  maxlength="30" size="30" disabled="disabled" />
                                           
                                        </div>
                                        <div class="form-group">
                                            <label for="user_name_baru">Email Baru</label>
                                            <input type="text" name="user_mail_baru" id="user_mail_baru" value="<?php echo $_smarty_tpl->tpl_vars['user_mail_baru']->value;?>
"  class="form-control"  maxlength="30" size="30" />
                                        </div>
                                    </div><!-- /.box-body -->

                                    <div class="box-footer">
                                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Simpan Email</button>
                                    </div>
                                </form>
                            </div><!-- /.box -->
                        </div><!-- /.col -->
