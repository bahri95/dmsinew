<?php /* Smarty version Smarty-3.1.17, created on 2016-08-04 22:34:07
         compiled from "application/views/private/account/status.html" */ ?>
<?php /*%%SmartyHeaderCode:13676030855774895d0df287-08214996%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '13676030855774895d0df287-08214996',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_5774895d219a34_49001924',
  'variables' => 
  array (
    'url_private' => 0,
    'notification_msg' => 0,
...
<?php if ($_valid && !is_callable('content_5774895d219a34_49001924')) {function content_5774895d219a34_49001924($_smarty_tpl) {?>                <section class="content-header">
                    <h1>
                        Profil
                        <small>panel</small>
                    </h1>
...
" />
                                    <div class="box-body">
                                    	<div class="form-group">
                                            <label for="user_name_baru">Nama Instansi</label>
...
" />
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <br />
											<div style="text-align:center"><img src="<?php echo $_smarty_tpl->tpl_vars['data']->value['photo'];?>
" style="max-width:200px;"  /></div>
                                        </div>
                                        <div class="form-group">
                                            <label for="user_name_baru">Upload Foto</label>
                                    ...
                                    <div class="box-footer">
                                        <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-picture"></span>  Simpan Foto</button>
                                    </div>
                                </form>
                            </div><!-- /.box -->
