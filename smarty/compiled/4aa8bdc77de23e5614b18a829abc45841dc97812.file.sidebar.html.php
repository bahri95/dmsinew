<?php /* Smarty version Smarty-3.1.17, created on 2016-08-17 12:31:47
         compiled from "application\views\web\base-layout\sidebar.html" */ ?>
<?php /*%%SmartyHeaderCode:2032857888fa34d0563-33932895%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2032857888fa34d0563-33932895',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_57888fa3526472_03615401',
  'variables' => 
  array (
    'url_search_base' => 0,
    'key' => 0,
...
<?php if ($_valid && !is_callable('content_57888fa3526472_03615401')) {function content_57888fa3526472_03615401($_smarty_tpl) {?><div class="col-md-3">
...
<?php }?></a> </div>
 ...
 - <?php echo $_smarty_tpl->tpl_vars['rs']->value['tanggal_selesai'];?>
    ...
    <div class="col-md-12">
     <h4 class="f-primary-b b-h4-special f-h4-special--gray f-h4-special">
     <?php if ($_smarty_tpl->tpl_vars['act_lang']->value=='en') {?>About Us<?php } else { ?>Tentang Kami<?php }?></h4>
...
$_smarty_tpl->tpl_vars['rs']->_loop = true;
?>
              <li><i class="fa fa-angle-double-right b-list-markers__ico f-list-markers__ico"></i> <a href="<?php echo $_smarty_tpl->tpl_vars['rs']->value['url_detail'];?>
"><?php echo $_smarty_tpl->tpl_vars['rs']->value['judul'];?>
</a></li>
            <?php } ?>
          <?php }?>  
     ...
     <div class="col-md-12">
     <h4 class="f-primary-b b-h4-special f-h4-special--gray f-h4-special">
     <?php if ($_smarty_tpl->tpl_vars['act_lang']->value=='en') {?>Visitor<?php } else { ?>Pengunjung<?php }?></h4>
    ...
    <noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?3536992&101" alt="web stats" border="0"></a></noscript>
    <!-- Histats.com  END  -->
    </div>
  </div>
</div>
