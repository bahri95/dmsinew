<?php /* Smarty version Smarty-3.1.17, created on 2016-06-29 11:51:12
         compiled from "application/views/private/video/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:1357130019577353c09082f6-86831995%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1357130019577353c09082f6-86831995',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_577353c0a07039_93852238',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_577353c0a07039_93852238')) {function content_577353c0a07039_93852238($_smarty_tpl) {?>
...
" />
                                   <div class="box-body">
                                        <div class="form-group">
                                            <label for="user_name_lama">Judul Video *</label>
                                            <input type="text" name="judul_video" class="form-control"  value="<?php echo $_smarty_tpl->tpl_vars['data']->value['judul_video'];?>
" size="100" maxlength="255" />
                                        </div>
                                        <div class="form-group">
                                          <label for="tipe">Tipe <strong><i><?php echo $_smarty_tpl->tpl_vars['tipe_video']->value;?>
</i></strong></label>
                                         
                                        </div>
                                      	<div class="form-group">
                                            <label for="user_name_lama">Potongan Gambar ( Max 500Kb, Min. Width 400px )</label> 
                                           <span>
                                                    <input  type="file" 
                                           ...
                                           <br />  <br /> <?php echo $_smarty_tpl->tpl_vars['data']->value['video_image'];?>
<br />
                                        ...
                                        <div class="form-group">
                                            <label for="user_name_lama">Video</label> 
                                           <div id="video-container"><?php echo $_smarty_tpl->tpl_vars['data']->value['video_file'];?>
</div><br /><br />
				<input type="button" id="uploader_video" value="Upload Video" class="btn btn-succes"  name="uploader" class="edit-button" /> <br /><span id="statusupload" style="font-size:14px;color:#3399CC;"></span>
          <br /><span>Click tombol diatas untuk mengupload video.</span>
            
                                        </div>
        								<?php }?>
                                         <?php if ($_smarty_tpl->tpl_vars['data']->value['tipe']=='embed') {?>
                                         <div class="form-group">
                                            <label for="user_name_lama">Embed Script *</label> 
                                        ...
                                        <div class="form-group">
                                            <label for="user_name_lama">Sumber Video </label>
...
" size="50" maxlength="50" />
                                  ...
                                  <div class="tab-pane" id="tab_2">
                                   <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="user_name_lama">Judul Video (<i>English</i> ) *</label>
