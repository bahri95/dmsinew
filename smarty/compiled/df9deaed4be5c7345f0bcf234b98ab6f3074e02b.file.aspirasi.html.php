<?php /* Smarty version Smarty-3.1.17, created on 2016-08-19 04:05:38
         compiled from "application/views/web/aspirasi/aspirasi.html" */ ?>
<?php /*%%SmartyHeaderCode:157697378057720ef9245ec1-05020407%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '157697378057720ef9245ec1-05020407',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_57720ef92e7504_14294404',
  'variables' => 
  array (
    'page_modul' => 0,
    'label' => 0,
...
<?php if ($_valid && !is_callable('content_57720ef92e7504_14294404')) {function content_57720ef92e7504_14294404($_smarty_tpl) {?>
...
" />
                ...
                <div class="b-form-row f-primary-l f-title-big c-secondary col-xs-offset-1"><b><?php echo $_smarty_tpl->tpl_vars['label']->value['petunjuk'];?>
</b></div>
                      ...
                      <div class="b-tagline-box">
                          <div class="f-tagline_description">
                             <ul class="b-list-markers f-list-markers">
                              <li><i class="fa fa-hand-o-right b-list-markers__ico f-list-markers__ico"></i><?php echo $_smarty_tpl->tpl_vars['label']->value['petunjuk1'];?>
</li>
                              <li><i class="fa fa-hand-o-right b-list-markers__ico f-list-markers__ico"></i><?php echo $_smarty_tpl->tpl_vars['label']->value['petunjuk2'];?>
<br/>
                              &nbsp;&nbsp;&nbsp;&nbsp;- <?php echo $_smarty_tpl->tpl_vars['label']->value['petunjuk3'];?>
<br/>
                              &nbsp;&nbsp;&nbsp;&nbsp;- <?php echo $_smarty_tpl->tpl_vars['label']->value['petunjuk4'];?>
</li>
                              <li><i class="fa fa-hand-o-right b-list-markers__ico f-list-markers__ico"></i><?php echo $_smarty_tpl->tpl_vars['label']->value['petunjuk5'];?>
</li>
                               <li><i class="fa fa-hand-o-right b-list-markers__ico f-list-markers__ico"></i><?php echo $_smarty_tpl->tpl_vars['label']->value['petunjuk6'];?>
</li>
                               <li><i class="fa fa-hand-o-right b-list-markers__ico f-list-markers__ico"></i><?php echo $_smarty_tpl->tpl_vars['label']->value['petunjuk7'];?>
</li>
                               <li><i class="fa fa-hand-o-right b-list-markers__ico f-list-markers__ico"></i><?php echo $_smarty_tpl->tpl_vars['label']->value['petunjuk8'];?>
</li>
