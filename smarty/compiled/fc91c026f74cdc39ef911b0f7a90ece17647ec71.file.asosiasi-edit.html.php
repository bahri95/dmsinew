<?php /* Smarty version Smarty-3.1.17, created on 2016-09-19 05:20:51
         compiled from "application\views\private\asosiasi\asosiasi-edit.html" */ ?>
<?php /*%%SmartyHeaderCode:21446578c94eb99f409-34988525%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fc91c026f74cdc39ef911b0f7a90ece17647ec71' => 
    array (
  ...
  'nocache_hash' => '21446578c94eb99f409-34988525',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_578c94ebaa8e48_77894613',
  'variables' => 
  array (
    'url_private' => 0,
    'url_list' => 0,
...
<?php if ($_valid && !is_callable('content_578c94ebaa8e48_77894613')) {function content_578c94ebaa8e48_77894613($_smarty_tpl) {?><section class="content-header">  <h1>    Asosiasi Anggota    <small>panel    </small>  </h1>  <ol class="breadcrumb">    <li>      <a href="<?php echo $_smarty_tpl->tpl_vars['url_private']->value;?>
...
" class="form-control" maxlength="150" />            </div>            <div class="form-group">              <label for="nama_kota">Profil              </label>              <textarea name="profil" id="profil" class="textarea form-control" cols="50" rows="10"><?php echo $_smarty_tpl->tpl_vars['data']->value['profil'];?>
              </textarea>            </div>            <div class="form-group">              <label for="nama_kota">Profil English              </label>              <textarea name="profil_english" id="profil" class="textarea form-control" cols="50" rows="10"><?php echo $_smarty_tpl->tpl_vars['data']->value['profil_english'];?>
...
" class="form-control" maxlength="150" />              </div>            </div>            <div class="form-group">              <label for="nama_kota">Alamat *              </label>              <textarea name="alamat" id="alamat"  class="form-control" ><?php echo $_smarty_tpl->tpl_vars['data']->value['alamat'];?>
