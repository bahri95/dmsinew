<?php /* Smarty version Smarty-3.1.17, created on 2016-08-30 07:58:11
         compiled from "application\views\private\aspirasi\list_jawaban.html" */ ?>
<?php /*%%SmartyHeaderCode:12608578df049bb0287-65881704%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd492a639868d6ae518382b8cb66f33a557296ede' => 
    array (
  ...
  'nocache_hash' => '12608578df049bb0287-65881704',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_578df049c737b3_11254433',
  'variables' => 
  array (
    'jumlah_aspirasi' => 0,
    'result' => 0,
...
" title="Edit Jawaban" class="btn btn-success btn-flat">                          <i class='fa fa-edit'>                          </i>                        </a>                      </div>                     </td>                  </tr>                  <?php } ?>                </tbody>              </table>              <!-- /.table -->            </div>            <!-- /.mail-box-messages -->             </div><!--panel body-->                  </div><!--panel default -->            </div>          <!-- /.box-body -->          <div class="box-footer no-padding">            <div class="mailbox-controls">              <!-- Check all button -->              <button class="btn btn-default btn-sm" type="submit" name="hapus">                <i class="fa fa-trash-o">                </i>              </button>            </div>          </div>          </form>      </div>      <!-- /. box -->    </div>    <!-- /.col -->    </div>  <!-- /.row -->  </section><!-- /.content --></div><!-- /.content-wrapper --><?php }} ?>
