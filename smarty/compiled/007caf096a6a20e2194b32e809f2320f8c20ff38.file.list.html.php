<?php /* Smarty version Smarty-3.1.17, created on 2016-07-29 03:20:07
         compiled from "application/views/private/regulasi/list.html" */ ?>
<?php /*%%SmartyHeaderCode:14097828935773406cadb8b3-23653263%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '14097828935773406cadb8b3-23653263',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_5773406cc0ebb3_15125232',
  'variables' => 
  array (
    'url_private' => 0,
    'notification_msg' => 0,
...
<?php if ($_valid && !is_callable('content_5773406cc0ebb3_15125232')) {function content_5773406cc0ebb3_15125232($_smarty_tpl) {?>
                        ...
                        <div class="col-md-12">
                        	<div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Daftar id_regulasi</h3>
                                     <div class="box-tools">
                                        ...
                                        <table id="table_datagrid" class="table table-bordered table-striped">
                                            <thead>
                                               ...
                                               <th width="5%" id="cekAll"><input type="checkbox" class="checked-all" name="checked-all"  id="checked-all"/ class="form-control"></th>
                                                ...
                                                <th width="25%" align="center">File</th>
...
?>
                                            <tr>
                                                <td align="center"><input type=checkbox name="id_regulasi[]" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['id_regulasi'];?>
" class="checkbox" /></td>
