<?php /* Smarty version Smarty-3.1.17, created on 2016-08-09 06:42:19
...
<?php if ($_valid && !is_callable('content_578c55329ccff0_18246057')) {function content_578c55329ccff0_18246057($_smarty_tpl) {?>
                <div class="col-md-9">
                <!--start detail desc-->
...
?>
                <div class="b-twitter-feeds__item b-tabs__content-list-item" style="margin-top:20px;">
                  <div class="b-twitter-feeds__item_name f-twitter-feeds__item_name f-primary-b"><i class="fa fa-angle-double-right"></i> <a href="<?php echo $_smarty_tpl->tpl_vars['rs']->value['url_detail'];?>
