<?php /* Smarty version Smarty-3.1.17, created on 2016-07-29 03:18:58
         compiled from "application/views/private/video/list.html" */ ?>
<?php /*%%SmartyHeaderCode:747569913577353a0a817f2-29856691%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '747569913577353a0a817f2-29856691',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_577353a0b641e6_64362326',
  'variables' => 
  array (
    'url_private' => 0,
    'notification_msg' => 0,
...
<?php if ($_valid && !is_callable('content_577353a0b641e6_64362326')) {function content_577353a0b641e6_64362326($_smarty_tpl) {?>
...
" name="form-koleksi" method="post" onsubmit="javascript:return konfirmasi_delete_data();">
                                    <div class="box-body table-responsive">
                                        ...
                                        <table id="table_datagrid" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                               <th width="2%" align="center"><input type="checkbox" name="id_video[]" class="checked-all" value="" /></th>
                                                <th width="6%" align="center">No</th>
                                                <th width="50%">Judul</th>
                                                <th width="19%">Tipe Video</th>
                                                <th width="12%"></th>
                                                </tr>
                                            </thead>
                                            <tbody>
...
?>
                                            <tr>
                                              <td align="center"><input type="checkbox" name="id_video[]" class="checkbox" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['id_video'];?>
" /></td>
...
<br/>
                                                ...
                                                Video : <br /><?php echo $_smarty_tpl->tpl_vars['result']->value['video_file'];?>
<br /><br />
                                                 <strong>Keterangan:</strong><br /><?php echo $_smarty_tpl->tpl_vars['result']->value['keterangan'];?>
<br/>
                                                   (<i><?php echo $_smarty_tpl->tpl_vars['result']->value['keterangan_english'];?>
</i>)<br /><br />
                                                <strong>Sumber : </strong><br /><?php echo $_smarty_tpl->tpl_vars['result']->value['sumber'];?>
<br />
                                                </td>
