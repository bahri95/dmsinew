<?php /* Smarty version Smarty-3.1.17, created on 2016-08-09 02:34:29
         compiled from "application\views\private\sosmed\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:241215798481012a0b8-33227326%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '241215798481012a0b8-33227326',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_579848101a70d9_96219385',
  'variables' => 
  array (
    'url_private' => 0,
    'url_list' => 0,
...
<?php if ($_valid && !is_callable('content_579848101a70d9_96219385')) {function content_579848101a70d9_96219385($_smarty_tpl) {?><section class="content-header">
                    <h1>
                     Sosial Media
                        <small>panel</small>
                    </h1>
...
"><i class="fa "></i>Data Sosial Media</a></li>
                        <li class="active">Update Data Sosial Media</li>
                    </ol>
                </section>
                        ...
                        <!-- form update email-->
                             <div class="box box-success">
                                <div class="box-header">
                                    <h3 class="box-title">Update Sosial Media</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
...
" <?php if ($_smarty_tpl->tpl_vars['data']->value['id_logo']==$_smarty_tpl->tpl_vars['result']->value['id_logo']) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['result']->value['logo'];?>
                                          ...
                                          <div class="form-group">
                                            <label for="user_name_lama">Link *</label>
