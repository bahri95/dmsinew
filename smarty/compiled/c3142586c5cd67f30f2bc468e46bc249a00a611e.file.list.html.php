<?php /* Smarty version Smarty-3.1.17, created on 2016-08-08 05:18:40
         compiled from "application/views/private/kota/list.html" */ ?>
<?php /*%%SmartyHeaderCode:624858057760cd18a2a99-01343739%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c3142586c5cd67f30f2bc468e46bc249a00a611e' => 
    array (
  ...
  'nocache_hash' => '624858057760cd18a2a99-01343739',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.17',
  'unifunc' => 'content_57760cd197acc3_89423943',
  'variables' => 
  array (
    'url_private' => 0,
    'notification_msg' => 0,
...
<?php if ($_valid && !is_callable('content_57760cd197acc3_89423943')) {function content_57760cd197acc3_89423943($_smarty_tpl) {?>
...
" <?php if ($_smarty_tpl->tpl_vars['result_propinsi']->value['id_propinsi']==$_smarty_tpl->tpl_vars['propinsi_selected']->value) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['result_propinsi']->value['nama_propinsi'];?>
                                    ...
                                    <div class="box-body table-responsive">
                                        <table id="table_datagrid" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                <th width="10%" style="text-align:center;">ID Kota</th>
...
?>
                                            <tr>
                                                <td align="center"><?php echo $_smarty_tpl->tpl_vars['result']->value['id_kota'];?>
</td>
...
/<?php echo $_smarty_tpl->tpl_vars['result']->value['id_kota'];?>
" title="Edit" class="btn btn-success btn-flat"><i class='fa fa-pencil'></i></a>&nbsp;<a href="<?php echo $_smarty_tpl->tpl_vars['url_delete']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['result']->value['id_kota'];?>
" title="Hapus" class="btn btn-danger btn-flat" id="btndel<?php echo $_smarty_tpl->tpl_vars['result']->value['id_kota'];?>
