...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57b6bb636a4312_69294721',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b6bb636a4312_69294721')) {function content_57b6bb636a4312_69294721($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<header>
      ...
      <form method="post" action="http://dmsi.or.id/index.php/public/pencarian/index" name="form-search"> <input type="text" name="keyword" value="" placeholder="Masukan kata pencarian"/></form>
      </span> </div>
               ...
               <div class="b-option-contacts f-primary-b">
                 ...
                 <a href="http://dmsi.or.id/index.php/public/lang/id" title="Indonesia"><img src="http://dmsi.or.id/doc/lang/indo.png" width="20">
                 </a>  &nbsp;&nbsp;
                 <a href="http://dmsi.or.id/index.php/public/lang/en" title="English"><img src="http://dmsi.or.id/doc/lang/eng.png" width="20"></a>
...
"></i></a>
      ...
      <div class="container b-header__box b-relative">
          <a href="/" class="b-left b-logo"><img class="color-theme" data-retina src="http://dmsi.or.id/themes/default/img/logo_dmsi.png" alt="Logo DMSI" style="margin-left:-50px;" /></a>
    ...
    <a href="http://dmsi.or.id/index.php/public/home"><i class="fa fa-home b-menu-1level-ico"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['home'];?>
    ...
    <?php }?>
        ...
        <div class="b-top-nav__dropdomn">
            <ul class="b-top-nav__2level_wrap">
                ...
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/profil"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['tentang_dmsi'];?>
</a></li>
                 <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/profil/detail/3/visi"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['visi'];?>
</a></li>
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/beritadmsi"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['berita_dmsi'];?>
</a></li>
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/kegiatandmsi"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['event_dmsi'];?>
</a></li>
 ...
 <span class="b-ico-dropdown"><i class="fa fa-arrow-circle-down"></i></span></a>
        <div class="b-top-nav__dropdomn">
            <ul class="b-top-nav__2level_wrap">
                ...
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/asosiasi"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['profil_anggota'];?>
</a></li>
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/beritaanggota"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['berita_anggota'];?>
</a></li>
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/kegiatananggota"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['event_anggota'];?>
</a></li>
...
"><i class="fa fa-angle-right"></i> <?php echo $_smarty_tpl->tpl_vars['rs']->value['kategori'];?>
            ...
            <ul class="b-top-nav__2level_wrap">
                ...
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/opini"  onClick="return true"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['opini'];?>
</a></li>
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/sesebi"  onClick="return true"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['sesebi'];?>
</a></li>
             ...
             <li class="b-top-nav__2level_title f-top-nav__2level_title"><?php echo $_smarty_tpl->tpl_vars['menu']->value['infografis'];?>
              ...
              <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/program" onClick="return true"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['program'];?>
</a></li>
              <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/bagan" onClick="return true"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['bagan'];?>
</a></li>
             </ul>
             <ul class="b-top-nav__2level_wrap">
              ...
              <li class="b-top-nav__2level_title f-top-nav__2level_title"><?php echo $_smarty_tpl->tpl_vars['menu']->value['harga'];?>
                ...
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/harga"  onClick="return true"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['grafik'];?>
</a></li>
    ...
    <?php }?>
        ...
        <div class="b-top-nav__dropdomn">
            <ul class="b-top-nav__2level_wrap">
                ...
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/foto"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['foto'];?>
</a>
                </li>
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="http://dmsi.or.id/index.php/public/video"><i class="fa fa-angle-right"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['video'];?>
</a>
                </li>
            </ul>
        </div>
    ...
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b">
    <?php }?>
     <a href="http://dmsi.or.id/index.php/public/regulasi"><i class="fa fa-inbox b-menu-1level-ico"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['regulasi'];?>
</a> </li>
    ...
    <?php } else { ?>
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b">
    <?php }?> <a href="http://dmsi.or.id/index.php/public/download"><i class="fa fa-code b-menu-1level-ico"></i>Download</a> </li>
    <?php if ($_smarty_tpl->tpl_vars['menu']->value['menu_aktif']=='sponsor') {?>
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b is-active-top-nav__1level">
    <?php } else { ?>
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b">
    <?php }?>  <a href="http://dmsi.or.id/index.php/public/sponsor"><i class="fa fa-inbox b-menu-1level-ico"></i>Sponsorship</a> </li> 
      <?php if ($_smarty_tpl->tpl_vars['menu']->value['menu_aktif']=='aspirasi') {?>
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b is-active-top-nav__1level">
    <?php } else { ?>
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b">
    <?php }?> <a href="http://dmsi.or.id/index.php/public/aspirasi"><i class="fa fa-inbox b-menu-1level-ico"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['aspirasi'];?>
</a> </li>     
      <?php if ($_smarty_tpl->tpl_vars['menu']->value['menu_aktif']=='kontak') {?>
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b is-active-top-nav__1level">
    <?php } else { ?>
    <li class="b-top-nav__1level f-top-nav__1level f-primary-b">
    <?php }?> <a href="http://dmsi.or.id/index.php/public/kontak"><i class="fa fa-list b-menu-1level-ico"></i><?php echo $_smarty_tpl->tpl_vars['menu']->value['kontak'];?>
</a> </li>   
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-xs-12">
                ...
                <nav class="b-bottom-nav f-bottom-nav b-right hidden-xs">
                    <ul>
                        <li class="is-active-bottom-nav"><a href="http://dmsi.or.id/index.php/public/home">Home</a></li>
                        <li><a href="http://dmsi.or.id/index.php/public/profil">
                        
                        Tentang kami
                        </a></li>
                        <li><a href="http://dmsi.or.id/index.php/public/kontak">
  ...
  <div class="container">
    <div class="b-footer-secondary row">
      <div class="col-md-3 col-sm-12 col-xs-12 f-center b-footer-logo-containter">
          <a href=""><img data-retina class="b-footer-logo color-theme" src="http://dmsi.or.id/themes/default/img/logo_dmsi_besar.png" alt="Logo"/></a>
