...
class adminmodel extends CI_Model {
    ...
    function get_administrator_list() {
			...
			$sql = "SELECT a.admin_name, a.jenis_kelamin, a.id_asosiasi, a.jabatan, a.no_telp, b.*, d.id_auth, d.auth_name, m. id_kota, k.nama_kota , k.id_propinsi, p.nama_propinsi, m.nama_asosiasi FROM administrator_m a INNER JOIN sys_user_m b ON a.id_user = b.id_user INNER JOIN sys_user_authority_t c ON b.id_user = c.id_user INNER JOIN sys_authority_m d ON c.id_auth = d.id_auth LEFT JOIN asosiasi_m m ON a.id_asosiasi = m.id_asosiasi LEFT JOIN spt_kota_m k ON m.id_kota= k.id_kota LEFT JOIN spt_propinsi_m p ON k.id_propinsi = p.id_propinsi";
  				 $query = $this->db->query($sql);
    ...
    function get_administrator_by_id($id_user) {
        $sql = "SELECT a.admin_name, a.jenis_kelamin, a.id_asosiasi, a.jabatan, a.no_telp, b.*, d.id_auth, d.auth_name, m. id_kota, k.nama_kota , k.id_propinsi, p.nama_propinsi, m.nama_asosiasi FROM administrator_m a INNER JOIN sys_user_m b ON a.id_user = b.id_user INNER JOIN sys_user_authority_t c ON b.id_user = c.id_user INNER JOIN sys_authority_m d ON c.id_auth = d.id_auth LEFT JOIN asosiasi_m m ON a.id_asosiasi = m.id_asosiasi LEFT JOIN spt_kota_m k ON m.id_kota= k.id_kota LEFT JOIN spt_propinsi_m p ON k.id_propinsi = p.id_propinsi WHERE b.id_user = ?";
