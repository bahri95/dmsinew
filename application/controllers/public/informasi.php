...
class Informasi extends MY_Controller {
    ...
    public function kategori($kategori) {
		...
		$config['base_url'] = site_url("public/informasi/kategori/$id_kategori");
        ...
        //get data kategori
       	...
       	$kategori = $this->informasimodel->get_list_kategori_public();
	...
	$this->smarty->assign("kategori", $kategori);
       ...
       if(!empty($result)):
		...
		$this->smarty->assign("page_modul_url", site_url('public/informasi/kategori/'.$id_kategori));
